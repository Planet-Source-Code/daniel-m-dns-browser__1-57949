...
Public Sub zSubclass_Proc(ByVal bBefore As Boolean, ByVal bHandled As Boolean, ByVal lReturn As Long, ByVal lng_hWnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long)
'Parameters:
...
Private Sub Subclass_AddMsg(ByRef lng_hWnd As Long, ByRef uMsg As Long, Optional ByRef When As eMsgWhen = MSG_AFTER)
...
Private Sub zAddMsg(ByRef uMsg As Long, ByRef aMsgTbl() As Long, ByRef nMsgCnt As Long, ByRef When As eMsgWhen, ByRef nAddr As Long)
...
Private Function zAddrFunc(ByRef sDLL As String, ByRef sProc As String) As Long
...
Private Sub zDelMsg(ByRef uMsg As Long, ByRef aMsgTbl() As Long, ByRef nMsgCnt As Long, ByRef When As eMsgWhen, ByRef nAddr As Long)
...
Private Function zSetTrue(ByVal bValue As Boolean) As Boolean
...
Private Sub fPaintPicture(ByVal m_Picture As StdPicture, ByVal X As Long, ByVal Y As Long, ByVal w As Long, ByVal h As Long)
...
Private Sub fDrawPicture(ByVal m_Picture As StdPicture, ByVal X As Long, ByVal Y As Long, ByVal bShadow As Boolean)
